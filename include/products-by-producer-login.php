<?php
	...
	$id = $_GET["id"];
    $sql = "SELECT * FROM products WHERE product_origin = '$id'";
...
<div class="heading">
    <h3 style="color: white">Sản phẩm của <?php echo $dong["product_origin"]; ?></h3>
    	</div>
    		<div class="see">
                            ...
                            <?php
                                    ?>                           
                                        ...
                                        <p><span class="rupees"></span><?php echo(number_format($dong['product_price'])) ?> đồng</p>
                                            ...
                                            <div class="add-cart">								
                                                <h4><a href="../login/preview-login.php">Add to Cart</a></h4>
                                            </div>
                                        <div class="clear"></div>
                                        </div>
                                    <?php					    
